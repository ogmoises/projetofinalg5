    ...
    <div className="min-h-screen flex flex-col items-center bg-branco p-6 pt- relative">    
      ...
      <div className="mt-20 w-full max-w-md px-4">
        <p className="text-sm text-center text-preto mb-6">
          Ao criar uma conta no Codelingo, você concorda com os nossos{" "}
          <Link href="/termos" className="text-preto font-semibold hover:underline">
            Termos
          </Link>{" "}
          e{" "}
          <Link href="/privacidade" className="text-preto font-semibold hover:underline">
        ...
        <p className="text-xs text-center text-preto mt-4">
          Este site é protegido pela reCAPTCHA Enterprise. Aplicam-se a{" "}
          <Link 
            href="https://policies.google.com/privacy" 
            className="text-preto font-semibold hover:underline"
            target="_blank"
