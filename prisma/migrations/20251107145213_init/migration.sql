...
-- CreateTable
CREATE TABLE "RespostasDoUsuario" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "usuario_id" INTEGER NOT NULL,
    "perguntas_id" INTEGER NOT NULL,
    "alt_selecionado" INTEGER NOT NULL,
    "acertou" BOOLEAN NOT NULL,
    CONSTRAINT "RespostasDoUsuario_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "Usuario" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "RespostasDoUsuario_perguntas_id_fkey" FOREIGN KEY ("perguntas_id") REFERENCES "Perguntas" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
